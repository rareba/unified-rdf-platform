...
async function loadConnections() {
  try {
    ...
    toast.add({ severity: 'error', summary: 'Error', detail: 'Failed to load connections', life: 3000 })
  }
}
...
async function connectToStore() {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: 'Connected', detail: 'Connected to triplestore', life: 3000 })
    await loadGraphs()
    loadNamespaces()
  } catch (e) {
    connectionStatus.value = 'Disconnected'
    toast.add({ severity: 'error', summary: 'Connection Failed', detail: 'Could not connect to triplestore', life: 3000 })
  } finally {
    loading.value = false
  }
}
...
async function loadGraphs() {
  try {
    ...
    toast.add({ severity: 'error', summary: 'Error', detail: 'Failed to load graphs', life: 3000 })
  }
}
...
async function loadGraphResources() {
  ...
  try {
    ...
    toast.add({ severity: 'error', summary: 'Error', detail: 'Failed to load graph resources', life: 3000 })
  } finally {
    loading.value = false
  }
}
...
async function executeQuery() {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: 'Executed', detail: 'Query executed successfully', life: 3000 })
  } catch (e: any) {
    queryError.value = e.message
    toast.add({ severity: 'error', summary: 'Query Failed', detail: e.message, life: 3000 })
  } finally {
...
function saveQuery() {
  toast.add({ severity: 'success', summary: 'Saved', detail: 'Query saved to history', life: 3000 })
}
...
async function uploadRdf() {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: 'Uploaded', detail: 'RDF data uploaded successfully', life: 3000 })
    await loadGraphs()
    uploadForm.value = { graphUri: '', format: 'turtle', method: 'file', content: '', file: null }
  } catch (error) {
    toast.add({ severity: 'error', summary: 'Error', detail: 'Failed to upload RDF data', life: 3000 })
  } finally {
