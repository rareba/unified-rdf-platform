...
CREATE SCHEMA IF NOT EXISTS shacl;
CREATE SCHEMA IF NOT EXISTS triplestore;

-- Grant usage to the application user
GRANT USAGE ON SCHEMA data TO rdfforge;
GRANT USAGE ON SCHEMA pipeline TO rdfforge;
GRANT USAGE ON SCHEMA job TO rdfforge;
GRANT USAGE ON SCHEMA dimension TO rdfforge;
GRANT USAGE ON SCHEMA shacl TO rdfforge;
GRANT USAGE ON SCHEMA triplestore TO rdfforge;

GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA data TO rdfforge;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA pipeline TO rdfforge;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA job TO rdfforge;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA dimension TO rdfforge;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA shacl TO rdfforge;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA triplestore TO rdfforge;

ALTER DEFAULT PRIVILEGES IN SCHEMA data GRANT ALL PRIVILEGES ON TABLES TO rdfforge;
ALTER DEFAULT PRIVILEGES IN SCHEMA pipeline GRANT ALL PRIVILEGES ON TABLES TO rdfforge;
ALTER DEFAULT PRIVILEGES IN SCHEMA job GRANT ALL PRIVILEGES ON TABLES TO rdfforge;
ALTER DEFAULT PRIVILEGES IN SCHEMA dimension GRANT ALL PRIVILEGES ON TABLES TO rdfforge;
ALTER DEFAULT PRIVILEGES IN SCHEMA shacl GRANT ALL PRIVILEGES ON TABLES TO rdfforge;
ALTER DEFAULT PRIVILEGES IN SCHEMA triplestore GRANT ALL PRIVILEGES ON TABLES TO rdfforge;

-- Legacy tables in public schema (kept for backward compatibility during migration)
